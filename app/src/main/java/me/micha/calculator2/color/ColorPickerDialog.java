package me.micha.calculator2.color;
...
/**
 * Created by micha on 07.04.2018.
 */
...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // Set the text color according to the brightness of the color
            if (Color.red(mDefaultColor) + Color.green(mDefaultColor) + Color.blue(mDefaultColor) < 384) mPaint.setColor(Color.WHITE);
            else mPaint.setColor(Color.BLACK); canvas.drawText("Cancel", 202, 340, mPaint);
        }
